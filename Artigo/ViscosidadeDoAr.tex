...
\begin{document}
	...
	\begin{multicols}{2} \begin{enumerate}
		...
		\item \textbf{Introdução}
			...
			\par Na seção 2, a parte teórica sobre viscosidade e oscilações amortecidas é rapidamente exposta. Na seção 3, o modelo experimental usado para obter dados é explicado. Na seção 4, a análise de dados e seus resultados são discutidos, abrangendo 3 métodos distintos. Por fim, as conclusões são apresentadas na seção 5.
