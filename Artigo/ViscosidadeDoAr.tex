...
\begin{document}
	...
	\begin{multicols}{2}
		...
		\label{sec:analise}
			...
			\par Com os dados da terceira configuração, um algoritmo escrito em MatLab (disponível aqui) foi utilizado para encontrar os máximos e, consequentemente, encontrar a constante $\gamma$ (equação \hyperref[eq:constantes]{\ref{eq:constantes}}). Com isso, conseguimos determinar o valor da viscosidade do ar como $\#.\#\# \cdot 10^{-5} \, Pa \cdot s$ (ignorando a incerteza).
			\begin{figure}[H]
				\centering
